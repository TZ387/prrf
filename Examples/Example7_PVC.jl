...
function geometryDefinition(grid_params::GridParams)
    ...
    M[Z .> 0.001] .= 2    # Skin (1 mm depth)
    M[Z .> 0.003] .= 3     # Fat (2 mm depth)  
    M[Z .> 0.008] .= 4    # Muscle (5.5 mm depth)
...
function define_material_properties()
    ...
    materials[1] = (name = "Teflon", sigma = 0.000078, epsilon_im = 0*epsilon_0, VHC = 1.0e6, k = 0.025)
